                    ...
                    <div class="row gx-5 align-items-center justify-content-center">
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h1 class="display-2 fw-bolder text-white mb-2">더 나은 것을<br>추구하는 힘!</h1>
                                <p class="lead fw-normal text-white-50 mb-4">어쩌구 저쩌구 이런 저런 <br>신뢰와 책임을 바탕으로 하는<br>준비된 개발자가 되겠습니다!</p>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                    <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#features">작업물 보러가기</a>
                                    <a class="btn btn-outline-light btn-lg px-4" href="#!">Contact</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="https://dummyimage.com/1200x800/000/fff" alt="..." /></div>
                    </div>
                </div>
            </header>
            <!-- Features section-->
